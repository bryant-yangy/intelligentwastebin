...
public class ImageUtil {
    ...
    public static synchronized  String getAuth() {
        if(token==null){
            ...
            String clientId = "IZN9uGFoba97zGlbguBrQZRO";
            // 官网获取的 Secret Key 更新为你注册的
            String clientSecret = "9jLTydzzG6UIrGmM2m9ouk8PnnzK1pgB";
...
//            }
    ...
    public static String identpicture(MultipartFile multipartFile){
    ...
    public static String getLocation(MultipartFile multipartFile) {
        // 请求url
